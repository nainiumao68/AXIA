"""AXIA config for the PIE-RGB-SAR dataset (RGB + SAR, 6 classes)."""
import os
...
C.dataset_path = './datasets/PIE-RGB-SAR'
...
C.x_norm_mean = np.array([0.348, 0.370, 0.309])
C.x_norm_std = np.array([0.197, 0.174, 0.171])
